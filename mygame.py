...
while run:
    ...
    if not finish:
        ...
        if sprite.collide_rect(ball, player2) and sprite.collide_rect(ball, player5) and ball.rect.y > 0:
            for i in range(40):
                ball.rect.y -= 1
        if sprite.collide_rect(ball, player4) and sprite.collide_rect(ball, player3) and ball.rect.y < 650:
            for i in range(40):
                ball.rect.y += 1
        ...
        if sprite.collide_rect(ball, player6) and sprite.collide_rect(ball, player7) and ball.rect.y > 0:
            for i in range(40):
                ball.rect.y -= 1
        if sprite.collide_rect(ball, player8) and sprite.collide_rect(ball, player9) and ball.rect.y < 650:
            for i in range(40):
                ball.rect.y += 1
